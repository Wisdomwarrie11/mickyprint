...
return(
    <>
    <div className="container-sm " style={{paddingTop: '150px'}}>
        <div className="row">
            <div className="col">
    ...
    {/* ABOUT PAGE */}
    <div className=" About container-sm" style={{marginTop: '150px'}}>
        <div className="row">
    ...
    {/* WHAT WE DO */}
    <div className="container-sm" style={{ backgroundColor: '#1A618B'}}>
    ...
    {/* PACKAGING DESING */}
    <div className="container-sm" style={{marginTop: '50px', backgroundColor: '#C4C6DB', paddingTop: '10px'}}>
        <div className="row">
    ...
    {/* OUR CUSTOMER */}
    <div className="container-sm text-center" style={{marginTop: '150px'}}>
        <div className="row">
            <div className="col">
    ...
    {/* OUR CONTACT*/}
  <div className=" Contact container-sm" style={{marginTop: '150px', paddingBottom: '50px' ,backgroundColor: '#EFDAD9'}}>
    <div className="row">
